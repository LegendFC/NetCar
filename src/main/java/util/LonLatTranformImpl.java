 ...
 */
public class LonLatTranformImpl {
	...
	public static LonLat gcj_To_LonLat84(double lon, double lat) {
		...
		double lontitude = lon * 2 - lonLat.getLongtitude();
		double latitude = lat * 2 - lonLat.getLatitude();
	...
	public static LonLat bd09_To_LonLat84(double bd_lon, double bd_lat) {
		...
		LonLat map84 = gcj_To_LonLat84(gcj02.getLongtitude(),
				gcj02.getLatitude());
		return map84;
	...
	public static void main(String[] args){
		...
		LonLat wgs84=gcj_To_LonLat84(gcj.getLongtitude(),gcj.getLatitude());
		LonLat gcj2=lonLat84_To_Gcj02(wgs84.getLongtitude(), wgs84.getLatitude());
		
		System.out.println("gcj "+gcj);
		System.out.println("wgs84 "+wgs84);
		System.out.println("gcj2 "+gcj2);
		
		LonLat bd=gcj02_To_Bd09(gcj.getLongtitude(), gcj.getLatitude());
		LonLat gcj3=bd09_To_Gcj02(bd.getLongtitude(), bd.getLatitude());
